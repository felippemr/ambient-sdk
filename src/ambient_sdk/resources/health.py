...
from ..types.health_retrieve_status_response import HealthRetrieveStatusResponse
...
class HealthResource(SyncAPIResource):
    ...
    def retrieve_status(
        ...
        *,
        ...
        """
        Retrieve the health status of the service, including a timestamp and status
        text.
        """
        return self._get(
            "/health",
